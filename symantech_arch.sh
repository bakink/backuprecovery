...
# ALLOCATE CHANNEL ch01 TYPE 'SBT_TAPE' maxopenfiles = 1; ORA-12805: parallel query server died unexpectedly hatasindan kapattim. Yusuf Ipek
SEND 'NB_ORA_POLICY=ORA_TEST_ARC, NB_ORA_SERV=netbckbckcls, NB_ORA_CLIENT=test_bck';
BACKUP
   filesperset 1
   FORMAT 'al_%s_%p_%t'
...
#
SEND 'NB_ORA_POLICY=ORA_ALTAY_ARC, NB_ORA_SERV=opcbckcls, NB_ORA_CLIENT=altay_bck';
BACKUP
    # recommended format
